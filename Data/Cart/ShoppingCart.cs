...
namespace GamingStoreProject.Data.Cart
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Laptop.Id == laptop.Id &&
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            return ShoppingCartItems ?? (ShoppingCartItems = _context.ShoppingCartItems.Where(n => n.ShoppingCartId ==
                ShoppingCartId).Include(n => n.Laptop).ToList());
        }

        public double GetShoppingCartTotal() => _context.ShoppingCartItems.Where(n => n.ShoppingCartId ==
            ShoppingCartId).Select(n => n.Laptop.Price * n.Amount).Sum();
